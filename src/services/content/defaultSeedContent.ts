...
export function buildDefaultSeedContent(): GameContentData {
  ...
  const artworks: ArtworkContent[] = [
    ...
    { id: '26', artworkId: '26', galleryId: 'gallery_01', title: 'چشم انداز در امتداد ساحل نیوهیون', imageUrl: 'https://www.olo.pics/images/2026/09/05/45fa62f550893fd78aad04a202819595.webp' },
    { id: '27', artworkId: '27', galleryId: 'gallery_02', title: 'مارشال‌های فرانسه', imageUrl: 'https://www.olo.pics/images/2026/09/05/1931-004.webp' },
    { id: '28', artworkId: '28', galleryId: 'gallery_03', title: 'جرونیمو', imageUrl: 'https://www.olo.pics/images/2026/09/05/1931-006.webp' },
    { id: '29', artworkId: '29', galleryId: 'gallery_04', title: 'کشتی طبقاتی', imageUrl: 'https://www.olo.pics/images/2026/09/05/1931-008.webp' },
    { id: '30', artworkId: '30', galleryId: 'gallery_05', title: 'کوه صلیب مقدس', imageUrl: 'https://www.olo.pics/images/2026/09/05/1931-010.webp' },
    { id: '31', artworkId: '31', galleryId: 'gallery_06', title: 'گاو مقاوم در برابر بحران', imageUrl: 'https://www.olo.pics/images/2026/09/05/1931-012.webp' },
    { id: '32', artworkId: '32', galleryId: 'gallery_07', title: 'مطالعه حرکت: مرد، پرش ایستاده به چپ', imageUrl: 'https://www.olo.pics/images/2026/09/05/1931-014.webp' },
    { id: '33', artworkId: '33', galleryId: 'gallery_08', title: 'دو لیمو و چهار لیموترش', imageUrl: 'https://www.olo.pics/images/2026/09/05/1931-016.webp' },
    { id: '60', artworkId: '60', galleryId: 'gallery-01', title: 'چشم انداز در امتداد ساحل نیوهیون', imageUrl: 'https://www.olo.pics/images/2026/09/05/--.webp' },
