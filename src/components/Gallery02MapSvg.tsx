  ...
  ({ className = '', children, mapMode, ...props }, ref) => {
    return (
      ...
      >
        <defs>
          <style>
            {`.cls-1{fill:#f8efe8;}.cls-2{fill:url(#linear-gradient);}.cls-3{fill:url(#linear-gradient-2);}.cls-4{fill:#2a2623;}.cls-5{fill:#998f56;stroke:#353329;stroke-miterlimit:10;}.cls-6{fill:none;}`}
          </style>
          <linearGradient
            id="linear-gradient"
            x1="347.17"
