    ...
    return (
      ...
      >
        <defs>
            <style>
              {`
                .g05-cls-1{fill:#f8efe8;}
                .g05-cls-2{fill:url(#g05-linear-gradient);}
                .g05-cls-3{fill:url(#g05-linear-gradient-2);}
                .g05-cls-4{fill:url(#g05-linear-gradient-3);}
                .g05-cls-5{opacity:0.2;}
                .g05-cls-6{fill:#2a2623;}
                .g05-cls-7{fill:#998f56;stroke:#353329;stroke-miterlimit:10;}
                .g05-cls-8{opacity:0.63;}
              `}
            </style>
            <linearGradient
              id="g05-linear-gradient"
              x1="176.03"
              y1="511.81"
              x2="241.52"
              y2="446.31"
            ...
            <linearGradient
              id="g05-linear-gradient-3"
              x1="27.94"
              y1="218.42"
              x2="92.28"
              y2="218.42"
              xlinkHref="#g05-linear-gradient-2"
              href="#g05-linear-gradient-2"
            />
          </defs>
          <g id="Layer_2" data-name="Layer 2">
            <g id="Layer_1-2" data-name="Layer 1">
              ...
              />
              <rect className="g05-cls-3" x="408.65" y="647.41" width="92.42" height="80.93" />
              <rect className="g05-cls-4" x="27.94" y="177.57" width="64.34" height="81.7" />
              <g className="g05-cls-5">
                <path
                  className="g05-cls-6"
              ...
              <rect className="g05-cls-7" x="397.98" y="676.93" width="11" height="24.46" rx="3" />
              <rect className="g05-cls-6" x="397.98" y="713.44" width="11" height="15.62" rx="3" />
              <rect className="g05-cls-7" x="502.23" y="676.93" width="11" height="24.46" rx="3" />
              <rect className="g05-cls-6" x="502.23" y="713.44" width="11" height="15.62" rx="3" />
              <rect className="g05-cls-7" x="27.68" y="166.72" width="24.46" height="11" rx="3" />
              <rect className="g05-cls-6" y="166.72" width="15.62" height="11" rx="3" />
              <rect className="g05-cls-7" x="27.68" y="259.5" width="24.46" height="11" rx="3" />
              <rect className="g05-cls-6" y="259.5" width="15.62" height="11" rx="3" />
              <g className="g05-cls-8">
                <rect
                  className="g05-cls-6"
                  x="216.37"
                  y="401.31"
