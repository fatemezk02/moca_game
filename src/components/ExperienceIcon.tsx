    ...
    case 'shadow-silhouette':
      ...
      return (
        <svg
          ...
          style={style}
        >
          {/* Classic human profile silhouette (نیمرخ سیلوئت) */}
          <path
            d="M 10.5 28
               C 11.8 26.5 12.5 24.5 12.5 23.0
               C 12.5 22.0 10.5 21.5 8.8 21.0
               C 7.8 20.5 7.8 19.5 8.8 18.8
               C 9.2 18.4 8.2 17.8 8.5 17.3
               C 8.9 16.8 8.2 16.3 8.8 15.6
               C 9.0 15.0 6.2 14.6 6.2 13.6
               C 7.5 12.8 9.2 11.5 9.5 10.0
               C 9.8 8.2 11.0 6.2 13.5 4.8
               C 15.2 3.8 18.0 3.8 20.5 5.0
               C 23.5 6.8 25.2 10.5 25.2 14.5
               C 25.2 18.5 23.8 21.5 21.5 23.5
               C 20.8 24.5 21.0 26.0 21.8 27.0
               C 22.8 27.6 23.8 27.8 24.5 28.0
               C 20.0 29.2 15.0 29.2 10.5 28.0 Z"
