...
const GALLERY_METADATA_MAP: Record<string, { num: string; name: string }> = {
  ...
  'gallery-02': { num: '۰۱', name: 'کیمیای نور' },
  'gallery_02': { num: '۰۱', name: 'کیمیای نور' },
  'gallery-03': { num: '۰۲', name: 'آلبوم‌های دیپلماتیک' },
  'gallery_03': { num: '۰۲', name: 'آلبوم‌های دیپلماتیک' },
  'gallery-04': { num: '۰۳', name: 'ثبت دوام ما' },
  'gallery_04': { num: '۰۳', name: 'ثبت دوام ما' },
  'gallery-05': { num: '۰۴', name: 'ضرب آهنگ شهر' },
  'gallery_05': { num: '۰۴', name: 'ضرب آهنگ شهر' },
  'gallery-06': { num: '۰۵', name: 'در کشاکش تماشا و استیلا' },
  'gallery_06': { num: '۰۵', name: 'در کشاکش تماشا و استیلا' },
  'gallery-07': { num: '۰۶', name: 'گذر از برون به درون' },
  'gallery_07': { num: '۰۶', name: 'گذر از برون به درون' },
  'gallery-08': { num: '۰۷', name: 'آونگ زمان' },
  'gallery_08': { num: '۰۷', name: 'آونگ زمان' },
