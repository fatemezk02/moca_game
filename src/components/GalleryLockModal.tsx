...
const GALLERY_DISPLAY_NAMES: Record<string, string> = {
  ...
  'gallery_02': 'کیمیای نور',
  'gallery_03': 'آلبوم‌های دیپلماتیک',
  'gallery_04': 'ثبت دوام ما',
  'gallery_05': 'ضرب آهنگ شهر',
  'gallery_06': 'در کشاکش تماشا',
  'gallery_07': 'گذر از برون به درون',
  'gallery_08': 'آونگ زمان',
  'gallery_09': 'تلاقی رسانه‌ها',
};
