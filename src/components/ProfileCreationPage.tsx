      ...
      <div className="w-full max-w-md bg-white border-[3px] border-[#1e1b18] rounded-3xl p-6 sm:p-8 shadow-[4px_4px_0px_#1e1b18] flex flex-col gap-8 my-auto shrink-0">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="user-name" className="text-sm font-bold text-[#4a443b]">
              نام شما
            </label>
            <input
              id="user-name"
              ...
              className="w-full h-12 px-4 rounded-xl border-2 border-[#1e1b18] bg-[#fbf9f9] text-[#1e1b18] font-bold outline-none focus:ring-4 focus:ring-[#f59e0b]/30 focus:border-[#f59e0b] transition-all placeholder:font-normal placeholder:text-gray-400"
              maxLength={20}
              autoComplete="off"
            />
          </div>
          ...
          <div className="flex flex-col gap-3">
            <label className="text-sm font-bold text-[#4a443b] text-center">
          ...
          <button
            ...
            className={`mt-4 w-full h-14 rounded-xl border-2 border-[#1e1b18] font-black text-lg transition-all ${
              isFormValid
                ...
                : 'bg-gray-200 text-gray-400 border-gray-300 shadow-none cursor-not-allowed opacity-70'
            }`}
          >
            ورود به بازی
          </button>
