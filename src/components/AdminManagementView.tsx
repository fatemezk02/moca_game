...
export const AdminManagementView: React.FC<AdminManagementViewProps> = ({
  ...
  > = {
    ...
    'gallery-03': [
      { id: 'artwork-g03-star', starId: 'star-03', title: 'در جست‌وجوی فن و فضیلت', defaultX: 361, defaultY: 347 },
      { id: 'star-04', starId: 'star-04', title: 'چهره‌های مشهور، در یک قاب', defaultX: 117, defaultY: 266 },
      { id: 'star-05', starId: 'star-05', title: 'ژاپن در یک قاب', defaultX: 117, defaultY: 315 },
      { id: 'star-06', starId: 'star-06', title: 'خودنگارهٔ چرخان نادار', defaultX: 442, defaultY: 214 },
    ],
    'gallery-04': [
      { id: 'star-07', starId: 'star-07', title: 'ایا عکاسی میتواند شبیه نقاشی باشد', defaultX: 361, defaultY: 740 },
    ],
    'gallery-05': [
      { id: 'star-08', starId: 'star-08', title: 'وقتی شهر از زاویه‌ای تازه دیده می‌شود', defaultX: 350, defaultY: 205 },
      { id: 'star-09', starId: 'star-09', title: 'پاریسِ اوژن آتژه', defaultX: 264, defaultY: 116 },
      { id: 'star-10', starId: 'star-10', title: 'انسان‌ها و شهر', defaultX: 595, defaultY: 240 },
      { id: 'star-11', starId: 'star-11', title: 'تقاطع مخروطها', defaultX: 433, defaultY: 582 },
    ],
    'gallery-06': [
      { id: 'star-12', starId: 'star-12', title: 'ستاره کشف ۱۲ — سیاستِ نگاه', defaultX: 201, defaultY: 620 },
      { id: 'star-13', starId: 'star-13', title: 'ستاره کشف ۱۳ — بستر معنا و تصویر', defaultX: 200, defaultY: 371 },
      { id: 'star-14', starId: 'star-14', title: 'ستاره کشف ۱۴ — تصویر و حافظه', defaultX: 200, defaultY: 493 },
    ...
    'gallery-09': [
      ...
      { id: 'col-g09-02', starId: 'star-24', title: 'سوپ داگر', defaultX: 360, defaultY: 341 },
      { id: 'col-g09-03', starId: 'star-25', title: 'عکس‌ها و اچینگ‌ها', defaultX: 355, defaultY: 130 },
      { id: 'col-g09-04', starId: 'star-26', title: 'سگ سه پا', defaultX: 324, defaultY: 90 },
      { id: 'star-27', starId: 'star-27', title: 'پروژهٔ محمد علی کلی', defaultX: 401, defaultY: 215 },
      { id: 'star-28', starId: 'star-28', title: 'تمام ساختمان های خیابان سان ست', defaultX: 253, defaultY: 667 },
    ],
  };
