    ...
    return (
      ...
      >
        <defs>
            <style>
              {`
                .g04-cls-1{fill:#f8efe8;}
                .g04-cls-2{fill:url(#g04-linear-gradient);}
                .g04-cls-3{fill:url(#g04-linear-gradient-2);}
                .g04-cls-4{fill:#998f56;stroke:#353329;stroke-miterlimit:10;}
                .g04-cls-5{fill:#2a2623;}
              `}
            </style>
            <linearGradient
              id="g04-linear-gradient"
              x1="12.28"
              y1="639.17"
              x2="87.16"
              y2="639.17"
          ...
          <g id="Layer_2" data-name="Layer 2">
            <g id="Layer_1-2" data-name="Layer 1">
              ...
              />
              <rect className="g04-cls-2" x="12.28" y="597.01" width="74.89" height="84.31" />
              <rect className="g04-cls-3" x="394.59" y="597.01" width="74.89" height="84.31" />
              <rect className="g04-cls-4" x="27.68" y="681.32" width="24.46" height="11" rx="3" />
              <rect className="g04-cls-5" y="681.32" width="15.62" height="11" rx="3" />
              <rect className="g04-cls-4" x="27.68" y="586.01" width="24.46" height="11" rx="3" />
              <rect className="g04-cls-5" y="586.01" width="15.62" height="11" rx="3" />
              <path
                className="g04-cls-5"
              ...
              />
              <rect className="g04-cls-4" x="446.41" y="681.32" width="24.46" height="11" rx="3" />
              <rect className="g04-cls-5" x="482.93" y="681.32" width="15.62" height="11" rx="3" />
              <rect className="g04-cls-4" x="446.41" y="586.01" width="24.46" height="11" rx="3" />
              <rect className="g04-cls-5" x="482.93" y="586.01" width="15.62" height="11" rx="3" />
            </g>
          </g>
        {children}
      </svg>
