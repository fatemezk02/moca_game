...
export function isGalleryReached(rawGalleryId: string): boolean {
  ...
  if (canon === 'gallery_03') {
    return isGalleryPuzzleCompleted('gallery_02') || isGalleryPuzzleCompleted('gallery-02');
  }
  if (canon === 'gallery_04') {
    return isGalleryPuzzleCompleted('gallery_03') || isGalleryPuzzleCompleted('gallery-03');
  }
  if (canon === 'gallery_05') {
    return isGalleryPuzzleCompleted('gallery_04') || isGalleryPuzzleCompleted('gallery-04');
  }
  if (canon === 'gallery_06') {
    return isGalleryPuzzleCompleted('gallery_05') || isGalleryPuzzleCompleted('gallery-05');
  }
  if (canon === 'gallery_07') {
    return isGalleryPuzzleCompleted('gallery_06') || isGalleryPuzzleCompleted('gallery-06');
  }
  if (canon === 'gallery_08') {
    return isGalleryPuzzleCompleted('gallery_07') || isGalleryPuzzleCompleted('gallery-07');
  }
