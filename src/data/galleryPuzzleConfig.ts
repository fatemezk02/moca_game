...
export const GALLERY_PUZZLE_REGISTRY: Record<string, GalleryPuzzleConfig> = {
    ...
    pieces: [
      {
        ...
        titleEn: 'Piece 01 — Northwest Arch',
        sizeType: 'small',
        questionId: 'gallery07-puzzle-q01',
        svgPath: G01_PATH_PIECE_01,
        viewBox: '0 0 1000 1000',
        standaloneViewBox: '-10 -10 570 590',
        standaloneWidth: 570,
      ...
      },
      {
        ...
        titleEn: 'Piece 02 — Southwest Relief',
        sizeType: 'small',
        questionId: 'gallery07-puzzle-q02',
        svgPath: G01_PATH_PIECE_02,
        viewBox: '0 0 1000 1000',
        standaloneViewBox: '-10 460 570 560',
        standaloneWidth: 570,
      ...
      },
      {
        ...
        titleEn: 'Piece 03 — Major East Wing (Final Piece)',
        sizeType: 'large',
        questionId: 'gallery07-puzzle-q03',
        svgPath: G01_PATH_PIECE_03,
        viewBox: '0 0 1000 1000',
        standaloneViewBox: '440 -10 570 1020',
        standaloneWidth: 570,
    ...
    pieces: [
      {
        ...
        titleEn: 'Piece 01 — Northwest Arch',
        sizeType: 'small',
        questionId: 'gallery08-puzzle-q01',
        svgPath: G01_PATH_PIECE_01,
        viewBox: '0 0 1000 1000',
        standaloneViewBox: '-10 -10 570 590',
        standaloneWidth: 570,
      ...
      },
      {
        ...
        titleEn: 'Piece 02 — Southwest Relief',
        sizeType: 'small',
        questionId: 'gallery08-puzzle-q02',
        svgPath: G01_PATH_PIECE_02,
        viewBox: '0 0 1000 1000',
        standaloneViewBox: '-10 460 570 560',
        standaloneWidth: 570,
      ...
      },
      {
        ...
        titleEn: 'Piece 03 — Major East Wing (Final Piece)',
        sizeType: 'large',
        questionId: 'gallery08-puzzle-q03',
        svgPath: G01_PATH_PIECE_03,
        viewBox: '0 0 1000 1000',
        standaloneViewBox: '440 -10 570 1020',
        standaloneWidth: 570,
  ...
  'gallery-09': {
    ...
    galleryNameFa: 'گالری ۰۹ — تلاقی رسانه‌ها',
    galleryNameEn: 'Gallery 09 — Intersection of Media',
    totalPieces: 3,
    aspectRatio: '1/1',
    artworkWidth: 1000,
    artworkHeight: 1000,
    pieces: [
      {
        ...
        titleEn: 'Piece 01 — Northwest Arch',
        sizeType: 'small',
        questionId: 'gallery09-puzzle-q01',
        svgPath: G01_PATH_PIECE_01,
        viewBox: '0 0 1000 1000',
        standaloneViewBox: '-10 -10 570 590',
        standaloneWidth: 570,
      ...
      },
      {
        ...
        titleEn: 'Piece 02 — Southwest Relief',
        sizeType: 'small',
        questionId: 'gallery09-puzzle-q02',
        svgPath: G01_PATH_PIECE_02,
        viewBox: '0 0 1000 1000',
        standaloneViewBox: '-10 460 570 560',
        standaloneWidth: 570,
      ...
      },
      {
        ...
        titleEn: 'Piece 03 — Major East Wing (Final Piece)',
        sizeType: 'large',
        questionId: 'gallery09-puzzle-q03',
        svgPath: G01_PATH_PIECE_03,
        viewBox: '0 0 1000 1000',
        standaloneViewBox: '440 -10 570 1020',
        standaloneWidth: 570,
